...
### Actividad 2 — Historias de Usuario (15%)
...
### Actividad 3 — Requisitos Funcionales (12%)
...
| Referencia a HU | Cada RF tiene asociada al menos una HU existente en la seccion 2, y la relacion tiene sentido. | La mayoria referencia HU pero hay RF sin referencia o con referencias que no coinciden. | No hay columna de HU relacionada, o las referencias apuntan a HU que no existen. |
...
### Actividad 4 — Requisitos No Funcionales (8%)
...
| 2 | Historias de Usuario | 15% |
| 3 | Requisitos Funcionales | 12% |

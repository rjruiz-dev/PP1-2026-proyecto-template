...
| Flujos alternativos | Hay al menos un flujo alternativo por CU que cubre un escenario real (error de validacion, dato inexistente, cancelacion). El flujo indica desde que paso del principal se desvia. | Hay flujos alternativos pero son triviales o no indican desde que paso se desvian. | No hay flujos alternativos, o son copia del flujo principal con cambios cosmeticos. |
